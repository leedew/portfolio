...
function bFunction(event) {
    ...
    const b_txt = ['Americano', 'Cappuccino', 'Vanilla Latte', 'Toffee nut Latte', 'Peach iced tea with Espresso', 'Affogato', 'Strawberry Latte'];
    const c_txt = [
        "역시 <span class='name'>아메리카노</span>가 국룰이지~",
        "계피향이 은근히 기분을 센치하게 만들어주는 <br><span class='name'>카푸치노</span>~",
        "달달한 <span class='name'>바닐라라떼</span>가 <br>내 마음도 부드럽게 만들어줘~",
        "고소한 견과류가 들어간 특별한 맛!<br> <span class='name'>토피넛라떼</span> 내 최애픽이야~",
        "<span class='name'>아이스티 샷 추가!</span> <br>난 요즘 이게 끌리더라~",
        "달달한 아이스크림에 에스프레소 한 잔! <br>으음~ <span class='name'>아포가토</span>가 날 특별하게 해~",
